...
class InspectMixin:
    @overload
    async def list_image_files(self: AsyncClientMixin, image_uuid: str, path: str) -> list[FileItemModel]: ...
    @overload
    def list_image_files(self: SyncClientMixin, image_uuid: str, path: str) -> list[FileItemModel]: ...

    @get("/v1/inspect/{image_uuid}/list", json=["files"])
    def list_image_files(self, image_uuid: str, path: str) -> list[FileItemModel]: ...
